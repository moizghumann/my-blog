...
const Slider = () => {
    return (
        <div className='h-20 flex flex-row h-22 w-full bg-hsl(204, 5%, 9%) overflow-hidden whitespace-nowrap relative before:absolute before:top-0 before:w-[250px] before:h-[100%] before:content-[""] before:z-10 
